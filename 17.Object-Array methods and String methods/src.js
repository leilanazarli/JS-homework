...
let  newArray=users.map((element)=>element.gender ==="male" ?element.name= `Mr ${element.name}` :element.name= `Ms ${element.name}`)
...
function reverseNum(num) {
   ...
   return (numText.concat(numText.split('').reverse().join(''))).toString() ;
}
...
function reverseString(str) {
    ...
    return str.concat(result.toString());
}console.log(reverseString(num1.toString()));
console.log(reverseString(num2.toString()));
console.log(reverseString(num3.toString()));

//example 3
function reverseString(str) {
    return str.concat(str.split('').reverse().join(''))
}
console.log( reverseString("246"));
console.log( reverseString("102"));
